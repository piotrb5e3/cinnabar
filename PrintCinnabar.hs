...
instance Print Expr where
  prt i e = case e of
    ...
    ERel expr1 relop expr2 -> prPrec i 3 (concatD [prt 4 expr1, prt 0 relop, prt 4 expr2])
    ...
    EPow expr1 expr2 -> prPrec i 6 (concatD [prt 6 expr1, doc (showString "^"), prt 7 expr2])
